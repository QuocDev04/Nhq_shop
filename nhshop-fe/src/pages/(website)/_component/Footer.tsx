const Footer = () => {
  ...
  <footer className="w-full lg:-mt-1 bg-gradient-to-b from-[#1A1E26] to-[#01100B]">
    <div className="relative lg:pt-[403px] mb:pt-[271px] lg:w-[900px] mb:w-[342px] mx-auto">
      {/* <!-- UNLOCK VOUCHER 20% --> */}
      <div
        className=" lg:left-0 lg:translate-x-0 w-full mb:left-1/2 mb:-translate-x-1/2 absolute top-0 -translate-y-[40.5%]">
        <div className="bg-[#05422C] lg:pb-[70px] px-6 py-[26px] lg:pt-[45px] lg:px-16 rounded-3xl">
          <h2
            className="text-[31px]/[123%] -tracking-[0.8px] lg:text-[64px]/[110%] lg:translate-y-0 -translate-y-0.5 lg:mt-5 lg:-tracking-[4px] text-white font-semibold uppercase">
          ...
          <form action=""
            ...
            <input type="text" className="w-full border border-[#346654] rounded-full py-4 pr-4 pl-6 lg:py-6 lg:px-11"
              placeholder="Email Address" />
            <button
              className="btn lg:!h-[72px] lg:w-auto w-full text-left lg:text-center pl-11 py-4 lg:px-[45px] lg:py-6 bg-[#17AF26] whitespace-nowrap text-white rounded-[100px]">Reveal
              coupon</button>
          </form>
        </div>
      </div>
