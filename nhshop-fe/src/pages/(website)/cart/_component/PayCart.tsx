                ...
                <div className="hidden lg:block">
                    <div className="w-full lg:p-6 mb:p-5 border rounded-2xl flex flex-col gap-y-[3px]">
                        ...
                        {cart.totalQuantity === 0 ? (
                            <button
                                disabled
                                className="bg-[#C8C9CB] px-10 h-14 rounded-[100px] text-white flex my-[13px] gap-x-4 place-items-center justify-center"
                            >
                                <span>Checkout</span>&emsp;&emsp;|&emsp;&emsp;
                                <span>
                            ...
                            <Link to={"/order"}>
                                <button className="bg-green-500 px-16 h-14 rounded-[100px] text-white flex my-[13px] gap-x-4 place-items-center justify-center">
                                    <span>Checkout</span>
                                    &emsp;&emsp;|&emsp;&emsp;
                                    <span>
                                        {formatCurrency(cart.finalTotalPrice)}
